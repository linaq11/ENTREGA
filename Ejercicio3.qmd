...
source("unal_julia_setup.R")
source("j_eval_j_plot.r")   # tu helper del curso

stopifnot(exists("j_eval"))
...
## Ejercicio 1 ¿Por qué es una mala práctica depender únicamente de la función “Reemplazar” (.replace() / gsub()) para quitar espacios accidentales al inicio o final de un texto en bases de datos geográficas grandes, en lugar de usar funciones dedicadas como strip() o trimws()?
...
## Ejercicio 2 — Impacto de NO convertir texto a Float antes de WKT
